            ...
            return (
              <li key={section.id} className="border-b border-ink/15">
                <Link
                  ...
                  className="group flex flex-wrap items-baseline gap-x-6 gap-y-1 py-5 transition-colors hover:text-shout focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring sm:py-6"
                >
