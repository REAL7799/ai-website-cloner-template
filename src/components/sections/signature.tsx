  ...
  return (
    <section className="border-b-2 border-ink bg-background">
      <div className="mx-auto w-full max-w-[110rem] px-5 py-20 sm:px-8 sm:py-28 lg:px-12">
          ...
          {dishes.map(({ section, item, blurb }, index) => (
            ...
            >
              ...
              >
                ...
                <span
                  aria-hidden="true"
                  className="absolute -top-6 left-4 shout text-[clamp(3.5rem,9vw,7rem)] text-shout"
                >
              ...
              <div className={cn(index % 2 === 1 ? "lg:order-1" : undefined)}>
                <p className="text-[0.62rem] font-bold uppercase tracking-[0.34em] text-label">
                  {section[locale]}
                </p>
                ...
                <div className="mt-8 flex flex-wrap items-baseline gap-x-6 gap-y-2">
                  {item.prices.map((price) => (
                    ...
                    >
                      <span className="shout text-4xl text-shout sm:text-5xl">
        ...
        <Link
          href={`/${locale}/menu`}
          className="group mt-20 inline-flex items-center gap-4 border-b-2 border-ink pb-2 text-sm font-bold uppercase tracking-[0.2em] text-foreground transition-colors hover:border-shout hover:text-shout focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-ring"
        >
          {t.signature.cta}
